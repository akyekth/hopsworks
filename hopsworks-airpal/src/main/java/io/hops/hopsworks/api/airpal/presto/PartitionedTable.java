package io.hops.hopsworks.api.airpal.presto;
...
public class PartitionedTable extends Table {
  ...
  @Override
  public int hashCode() {
    return getConnectorId().hashCode() + getSchema().hashCode() + getTable().hashCode() + ((getTable() == null) ? 0
        : getTable().hashCode());
  }
  ...
  public boolean equals(Object obj) {
    if (obj instanceof PartitionedTable) {
      ...
      return getConnectorId().equals(otherTable.getConnectorId()) && getSchema().equals(otherTable.getSchema())
          && getTable().equals(otherTable.getTable()) && partitionsSame(partitionName, otherTable.getPartitionName());
    } else {
      return false;
    }
  }
