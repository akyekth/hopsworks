...
public class PreviewTableCache {
  ...
  private static String buildQueryWithLimit(PartitionedTableWithValue tableWithValue, int limit) {
    ...
    if (partition != null) {
      ...
      String partitionValue = (Objects.equals(partition.getType(), "varchar")) ? "'" + value + "'" : String.valueOf(
          value);
  ...
  private List<List<Object>> queryRows(String query) {
    ...
    QueryClient queryClient = new QueryClient(queryRunner, org.joda.time.Duration.millis(60 * 1000), query);
